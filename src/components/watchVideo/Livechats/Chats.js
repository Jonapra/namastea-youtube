...
const Chats = () => {
  ...
  return (
    <div className="liveChats-container border-2 border-white w-[401px] h-[595px] rounded-lg flex flex-col">
      <h2 className="font-bold px-2 py-2 border-b-2 border-white text-white text-lg">Top Chats</h2>
      ...
      <form 
        ...
        className="liveChats-container border-t-2 border-black p-2 flex font-semibold"
      >
        <input
          type="text"
          placeholder="Chat..."
